...
export class CreateUserDto {
    ...
    @MaxLength(50, {
        message: 'Username name length must be at most 50 characters'
    })
    ...
    @MaxLength(50, {
        message: 'Password name length must be at most 50 characters'
    })
    ...
    @IsEmail({ ignore_max_length: true }, { message: 'Should be valid email address' })
    email: string
}
